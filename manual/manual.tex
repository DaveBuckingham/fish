...
succesfully installed with the Anaconda Python distribution
(\url{https://www.anaconda.com}), but tetsts failed to install \name{} with a
...
\name{} is invoked by the Python interpreter explicitely:
\texttt{
\# python \name{}
}
...
This sections briefly describes each of the source code files for \name{}.

\begin{description}

\item[ic\_data.py]
\item[ic\_get\_basis.py]
\item[ic\_gui.py]
\item[ic\_plot.py]
\item[ic\_process\_dialog.py]
\item[ic\_process.py]
\item[ic\_rx.py]
\item[ic\_settings.py]
\item[ic\_tx/ic\_tx.ino]
