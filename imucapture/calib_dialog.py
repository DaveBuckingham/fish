...
class Calib_dialog(PyQt5.QtWidgets.QWidget):
    ...
    def __init__(self, calib):
        ...
        for i in range(0, 3):
            range_as_seconds = (calib.intervals[i][0] / Global_data.SAMPLE_FREQ_HZ, calib.intervals[i][1] / Global_data.SAMPLE_FREQ_HZ)
    ...
    def set_axes(self):
        ...
        Global_data.calibration = self.calib
        logging.info("calibration set")
        for window in (Global_data.data_window_list):
